...
for letter in range(0,26):
    letter_count = random_string.count((alphabet[letter]))
    letters[alphabet[letter]] = letter_count
print(letters)

min_value = min(letters.values())
for key,value in letters.items():
    if value == min_value:
        print(f'{key} occurs the least')

max_value = max(letters.values())
for key,value in letters.items():
    if value == max_value:
        print(f'{key} occurs the most')

for key,value in letters.items():
    percent = value / len(random_string) * 100
